                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _OptionTile(
                      ...
                      title: AppLocalizations.of(context)!.addToLibrary,
                      onTap: () async {
                        final lib = Provider.of<LibraryProvider>(context, listen: false);
                        await lib.addSongToLibrary(widget.song);
                        if (context.mounted) {
                          Navigator.pop(context);
  ...
  Future<void> _toggleFavorite(BuildContext context) async {
    ...
    try {
      ...
      if (mounted) {
        ...
        messenger.showSnackBar(
          SnackBar(
            content: Text(isFav ? l10n.addedToLikedSongs : l10n.removedFromLikedSongs),
            duration: const Duration(seconds: 2),
          ),
        );
      }
