...
class RecommendationService extends ChangeNotifier {
  ...
  List<Song> _dynamicRecommendations = [];
  List<Song> get dynamicRecommendations => _dynamicRecommendations;
  String _lastStudiedArtist = '';
  bool _isFetchingStudied = false;
  ...
  List<String> getTopArtists([int limit = 5]) => _getTopArtists(limit);

  Future<void> refreshStudiedRecommendations({bool force = false}) async {
    if (!_enabled || _isFetchingStudied) return;
    ...
    _isFetchingStudied = true;
    _lastStudiedArtist = targetArtist;
    ...
    try {
      ...
      debugPrint('[RecommendationService] refreshStudiedRecommendations error: $e');
    } finally {
